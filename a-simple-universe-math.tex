...
that the universe is around $14$ billion years old, or that the sun will die
in some distant future, becoming a white dwarf
\svn{also add examples of things which are space-distant from us.}.
...
\svn{Do I need this paragraph? Most likely not.}
...
Let us take such a chunk of space
\svn{I should not try to take a random region.}
and let us cover it with a finite cuboid (axiom \ref{finitecovering}).
We can then apply the same argument as in section \ref{fdaumu} to any
such cuboids, by considering it as a mini-unverse inside our universe.
...
is designed.
\svn{
  This paragraph and the previous one are really obscure.
  The argument goes like this:

  1. There is a finite chunk with infinite observable description.
  2. There is a finite cuboid with infinite observable description
     that includes it.
  3. Any cuboid that is far enough has an infinite observable description
     (because countable).
}
...
\begin{itemize}
  ...
  \item our universe is infinite, all infinite cuboids have infinite
        descriptions, while all finite cuboids
