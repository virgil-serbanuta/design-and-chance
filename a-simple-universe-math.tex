...
\maketitle
 ...
 \begin{abstract}
  This \paper{} argues that one can make a prediction about our universe
  from the hypothesis that our universe is not designed, regardless
  of how many universes exist, whether it is one, or all logically
  possbile ones, or anything in between.
  To be specific, it argues
  that our universe should have has a high
  level of complexity of a certain kind, and that this complexity would be
  easily observable everywhere.
  However, this is not what we observe, which
...
To be specific, I am arguing that, in the context of all possible universes
...
briefly presents some mathematical background for those interested in it.
