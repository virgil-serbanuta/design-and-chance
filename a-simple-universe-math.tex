...
\begin{itemize}
  ...
  \item TODO: Maybe include elsewhere: Given a similarity measure, and given a countable maximal set of purposes
        (called choosable purposes) that are not too similar,
        there are various ways of splitting the
        full set of purposes in smaller sets (buckets) such that each set
        contains exactly one choosable purpose, and each purpose in a bucket is
        "too similar" to the choosable purpose in that bucket, and 
\end{itemize}
