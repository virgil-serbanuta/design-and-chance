...
that there are certain laws that explain our universe's behaviour fairly well,
...
This argument can be considered a statistical approach to Aquinas' fifth way.
...
case unless
a Designer intended it and moreover, it's probable that the
...
With these arguments made, we can start the main part of the argument
which can be stated: that, in the context of all the possible universes that could
