...
\citetitle{swinburne1968} leaves open an objection to Aquinas' argument:
...
If such a $\beta<\alpha$ does not exist, then all
probability distributions $p_\delta$ exist,
with $\delta$ going up to $\alpha$ and,
perhaps, including it.
If, additionally, $\alpha$ is countable, then,
...
for any set of cuboids whose descriptions include the $D_f$ set, we can't
